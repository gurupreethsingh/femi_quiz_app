...
const RESET_PASSWORD_SECRET = process.env.RESET_PASSWORD_SECRET || 'ecoders_reset_password_secret';
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/mcdonal_tivan';
...
}).fields([{ name: 'profileImage' }, { name: 'backgroundImage' }, { name: 'images' }]);

// Function to compress images using sharp
const compressImage = async (filePath) => {
    const compressedFilePath = filePath.replace(path.extname(filePath), '-compressed.jpg');
